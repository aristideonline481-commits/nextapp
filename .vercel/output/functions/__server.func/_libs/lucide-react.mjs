...
const Bath = createLucideIcon("bath", __iconNode$u);
...
const ChefHat = createLucideIcon("chef-hat", __iconNode$s);
...
const Droplets = createLucideIcon("droplets", __iconNode$k);
const __iconNode$j = [
  [
    "path",
    {
